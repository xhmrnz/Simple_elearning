...
<head>
 ...
 <?php
    if( ! empty ($list_materi)){ // Jika data pada database tidak sama dengan empty (alias ada datanya)
  foreach($list_materi as $data) ?>
      <?php { ?>
</head>
<body>
    ...
    <div class="ui container">
      ...
      <a href="#" class="itemright">Logout<br></a>
    </div>
  </div>

  <div class="ui main text container">
    <h1 class="ui header"><?= $data->judul; ?></h1>
    <p><a href="<?php echo base_url("/crud/upgambar"); ?>">Tulis Materi</a></p>
  </div>
...
?>
    <div class="overlay">
      <div class="ui labeled icon vertical menu">
        <p><?= "<img src='".base_url("images/".$data->image)."' width='300' height='300'>"; ?></p>
      </div>
    </div>
